...
public class Visir extends Pedina {

    // Costruttori
    public Visir(Team team, TipoPedina tipoPedina, Point posizione) {
    ...
    private Point posizioneAttacco0() {
        return new Point((posizione.getX() + 1), (posizione.getY()));
    }
    private Point posizioneAttacco1() {
        return new Point((posizione.getX() - 1), (posizione.getY()));
    }
    private Point posizioneAttacco2() {
        return new Point((posizione.getX()), (posizione.getY() + 1));
    }
