...
public class Zebra extends Pedina {

    // Costruttori
    public Zebra(Team team, TipoPedina tipoPedina, Point posizione) {
    ...
    private Point posizioneAttacco0() {
        return new Point((posizione.getX() + 3), (posizione.getY() + 2));
    }
    ...
    private Point posizioneAttacco4() {
        return new Point((posizione.getX() + 2), (posizione.getY() + 3));
    }
