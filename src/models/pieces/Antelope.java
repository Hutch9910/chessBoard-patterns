...
public class Antelope extends Piece {
    ...
    // Constructors
    public Antelope(Team team, TypeOfPiece typeOfPiece, Point position) {
        super(team, position);
    ...
    private Point attackPosition0() {
        return new Point((position.getX() + 4), (position.getY() + 3));
    }
    ...
    private Point attackPosition4() {
        return new Point((position.getX() + 3), (position.getY() + 4));
    }
